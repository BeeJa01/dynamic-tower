...
const SECTIONS = [
  ...
  { title: "5. Your Rights",                body: "You have the right to access, correct, or delete your personal data. You may also object to processing or request data portability. To exercise any of these rights, email privacy@yourbrand.com." },
